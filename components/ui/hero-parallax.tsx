...
export const HeroParallax = ({
  ...
  const rotateZ = useTransform(scrollYProgress, [0, 0.2, 1], [20, 0, 0])
  const translateY = useTransform(scrollYProgress, [0, 0.2, 1], [-700, 0, 0])

  return (
    <div
      ref={ref}
      className="h-[160vh] py-40 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold dark:text-white">
        Our AI <span className="gradient-text">Tools</span>
      </h1>
